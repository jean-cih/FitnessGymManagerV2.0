...
namespace GymApplicationV2._0.Components
{
    public partial class JeanFormStyle : Component
    {
        ...
        private Dictionary<fStyle, JeanStyle> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private JeanStyle CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        public JeanFormStyle()
        {
            InitializeComponent();
        }
        public JeanFormStyle(IContainer container)
        {
            DefineStyles();
        ...
        {
            StylesDictionary = new Dictionary<fStyle, JeanStyle>();
            ...
            StylesDictionary.Add(fStyle.SimpleDark,
                new JeanStyle()
                {
                    ...
                    HeaderHeight = 38,
                    HeaderColor = ColorTranslator.FromHtml("#34495e"),
            ...
            StylesDictionary.Add(fStyle.TelegramStyle,
                new JeanStyle()
                {
                    ...
                    BackColor = Color.White,
                    HeaderHeight = 20,
                    HeaderColor = ColorTranslator.FromHtml("#f1f1f1"),
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                JeanStyle NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void SaveUserStyleConfig()
        {
            if (StylesDictionary.ContainsKey(fStyle.UserStyle) && StyleUsed == false)
            {
                ...
                JeanStyle UserStyle = StylesDictionary[fStyle.UserStyle];
        ...
        private void DrawStyle(Graphics graph)
        {
            ...
            if (Form.ControlBox == true)
            {
                ...
                graph.DrawRectangle(new Pen(btnCloseHovered ? ColorTranslator.FromHtml("#e81123") : Color.Transparent), rectBtnClose);
                graph.FillRectangle(new SolidBrush(btnCloseHovered ? ColorTranslator.FromHtml("#e81123") : Color.Transparent), rectBtnClose);
